# Red Hat AI Development Roadshow - AI Model Builder Track

To consult the static version of the instructions, please use this URL https://rh-rad-ai-roadshow.github.io/builder-guides/[this URL].
